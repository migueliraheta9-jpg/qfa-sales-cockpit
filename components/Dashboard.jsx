...
import { Plus, Eye, Trash2, Flame, Activity, Snowflake, CheckCircle2 } from 'lucide-react';
...
export default function Dashboard({ leads, onNewCall, onOpenLead, onDeleteLead, loading }) {
    ...
    <div className="min-h-screen" style={{ background: COLORS.bg }}>
      <div className="max-w-7xl mx-auto px-10 py-12">
        ...
        <div className="flex items-end justify-between mb-12 pb-8 border-b" style={{ borderColor: COLORS.border }}>
          <div>
            ...
            <p className="mt-4 text-lg" style={{ color: COLORS.muted, fontFamily: 'Instrument Serif, serif', fontStyle: 'italic' }}>
              Diagnóstico, cierre y seguimiento — guion v2.0
            </p>
          </div>
          <button
            onClick={onNewCall}
        ...
        <div className="rounded-lg overflow-hidden border" style={{ borderColor: COLORS.border }}>
          <div className="grid grid-cols-12 gap-3 px-5 py-3 text-[10px] tracking-[0.25em] font-bold" style={{ background: COLORS.bgLight, color: COLORS.muted }}>
            <div className="col-span-3">PROSPECTO</div>
            <div className="col-span-2">ESTADO</div>
            <div className="col-span-1">TEMP</div>
            <div className="col-span-2">CUELLO BOTELLA</div>
            <div className="col-span-2">CIFRA / BONO</div>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((lead) => {
              ...
              return (
                <div
                  key={lead.id}
                  className="grid grid-cols-12 gap-3 px-5 py-4 items-center border-t hover:bg-white/[0.02] transition cursor-pointer"
                ...
                >
                  ...
                  <div className="col-span-1" style={{ fontFamily: 'JetBrains Mono, monospace', color: COLORS.cyan }}>
                    {lead.temperatura || '—'}
                  </div>
                  <div className="col-span-2 text-sm">{cuello}</div>
                  <div className="col-span-2 text-sm" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
